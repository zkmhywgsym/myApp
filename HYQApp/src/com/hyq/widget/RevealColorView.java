...
import com.hyq.widget.ripple.BakedBezierInterpolator;
import com.hyq.widget.ripple.UiHelper;
import com.hyqapp.R;
...
public class RevealColorView extends ViewGroup{
	...
	public void reveal(int x, int y, final int color, int startRadius, int duration,
	...
	private ViewPropertyAnimator prepareAnimator(ViewPropertyAnimator animator,
			int type) {
